...
claim3 = Claim.create!(number: "098723331", at_date: "02-05-2019", description: "Issues opening door, broken doorhandle as a result of wear & tear", user: insurance2, garage_id: gael.id)
...
claim5 = Claim.create!(number: "748292355", at_date: "27-03-2019", description: "Driver lost control in the rain and had a side impact with a curb. Rear right wheel/tire & suspension components damaged", user: insurance1, garage_id: gael.id)
...
claim10 = Claim.create!(number: "602366301", at_date: "30-05-2019", description: "Driver hit highway divider due to falling asleep, full left side body damage", user: insurance2, garage_id: gael.id)
...
claim12 = Claim.create!(number: "414321260", at_date: "09-05-2019", description: "Left rear rim & tire damage from parking accident (driver scratched against a high curb)", user: insurance2, garage_id: gael.id)
...
claim15 = Claim.create!(number: "742360122", at_date: "19-01-2019", description: "Car + tram collision - front right side full repair (fender + headlight + sensors + radiator + fog light + frame damage)", user: insurance1, garage_id: gael.id)
