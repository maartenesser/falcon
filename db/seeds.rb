...
# order1 = Order.create!(user: nathanael, status: "pending", part: part10)
# order2 = Order.create!(user: nathanael, status: "paid", part: part9)
...
order9 = Order.create!(user: nathanael, status: "pending", part: part2)
order10 = Order.create!(user: nathanael, status: "paid", part: part4)
